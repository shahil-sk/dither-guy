# dither_guy/matrices.py
# Pre-computed ordered-dither threshold matrices (Bayer, clustered-dot,
# halftone, blue-noise, void-and-cluster, etc.).  Every matrix is a 2-D
# NumPy float32 array in the 0-255 range so it can be compared directly
# against pixel values without any extra scaling step.
...
# ── Halftone-style ordered matrices ───────────────────────────────────────────
...
_VOID_CLUSTER_8x8 = np.array([
    [  3, 200,  56, 168,  24, 216,  72, 184],
    [136,  88, 240, 104, 152,  40, 248, 120],
    [ 48, 176,  16, 224,  64, 192,   8, 160],
    [208,  80, 144,  32, 232,  96, 128,  16],
    [ 28, 228,  60, 172,   4, 204,  52, 180],
    [164,  44, 252, 116, 140,  68, 236, 108],
    [ 76, 196,  20, 148,  84, 212,  36, 156],
    [220,  92, 132,  12, 244, 124, 100,  68],
], dtype=np.float32)

# ── Dot-diffusion class matrix ─────────────────────────────────────────────────
...
# ── Convenience lookup — keyed by the algorithm name string ───────────────────
